...
public interface AndroidSettingsConstants {
   ...
   */
  public static final String PREFS_KEY_ENABLE_DATA_ENCRYPTION = "ENABLE_DATA_ENCRYPTION";

  /**
   * Default encryption setting
   */
  public static final boolean PREFS_KEY_DEFAULT_ENABLE_DATA_ENCRYPTION = true;
